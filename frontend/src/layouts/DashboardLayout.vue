...
const allNavItems = [
  { name: 'Dashboard', to: '/dashboard', icon: DashboardOutlined, roles: ['public_user', 'researcher', 'admin'] },
  { name: 'Resources', to: '/resources', icon: FolderOpenOutlined, roles: ['public_user', 'researcher', 'admin'] },
  { name: 'Activity', to: '/activity', icon: HistoryOutlined, roles: ['public_user', 'researcher', 'admin'] },
  { name: 'Admin Panel', to: '/admin', icon: UnlockOutlined, roles: ['admin'] },
  { name: 'Settings', to: '/settings', icon: SettingOutlined, roles: ['public_user', 'researcher', 'admin'] },
]
