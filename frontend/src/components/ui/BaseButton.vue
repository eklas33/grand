...
const variantClasses = computed(() => {
  ...
  const variants: Record<string, string> = {
    primary:
      'bg-gradient-to-r from-[#6C2BD9] to-[#5d21c0] text-white shadow-[0_4px_14px_rgba(108,43,217,0.4)] hover:shadow-[0_6px_20px_rgba(108,43,217,0.5)] hover:from-[#7B3DE8] hover:to-[#6C2BD9] focus-visible:ring-purple-500/40',
    secondary:
